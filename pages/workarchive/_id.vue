...
.container
  #page-wrap
    .main-content(v-touch:swipe.left="swipeLeftHandler" v-touch:swipe.right="swipeRightHandler")
      ...
      .move-page
        nuxt-link.move-page__button(aria-label="prev-button" v-on:mouseover.native="mouseover" v-on:mouseleave.native="mouseleave" :to="{ name: 'workarchive-id', params: { id: calcPrevId($route.params.id) } }")
          font-awesome-icon(icon="long-arrow-alt-left")
          |  PREV 
        nuxt-link.move-page__home(v-on:mouseover.native="mouseover" v-on:mouseleave.native="mouseleave" to="/archive" style="display:inline;")
          font-awesome-icon(:icon="['fas', 'th']")
        nuxt-link.move-page__button(aria-label="next-button" v-on:mouseover.native="mouseover" v-on:mouseleave.native="mouseleave" :to="{ name: 'workarchive-id', params: { id: calcNextId($route.params.id) } }")
          | NEXT 
...
export default {
  ...
  methods: {
    ...
    swipeRightHandler: function(direction){
      ...
      this.$router.push({ name: 'workarchive-id', params: {id: prevId} });
    },
    swipeLeftHandler: function(direction){
      ...
      this.$router.push({ name: 'workarchive-id', params: {id: nextId} });
    }
  }
}
